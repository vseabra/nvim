...
wk.add({
	...
	{ "<leader>dw", "<cmd>lua require('dapui').elements.watches.add(vim.fn.expand('<cword>'))<cr>", desc = "add word to watches" },
	{ "<leader>l", group = "lsp" },
	...
	{ "<leader>tc", "<cmd>Sidekick cli toggle<cr>", desc = "Copilot chat" },
